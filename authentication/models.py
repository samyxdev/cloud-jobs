...
AWS_REGION = os.environ.get('AWS_REGION_GET')
AWS_ACCESS_KEY_ID= os.environ.get('AWS_ACCESS_KEY_ID_GET')
AWS_SECRET_ACCESS_KEY = os.environ.get('AWS_SECRET_ACCESS_KEY_GET')
...
class Jobs(models.Model):
    ...
    # need to define a way to distinguish between users in the DynamoDB
